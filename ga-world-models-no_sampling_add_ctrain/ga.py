...
class GA:
    ...
    def crossover_params(self, parent1, parent2):
        ...
        ch1 = parent1.clone_individual()
        ch2 = parent2.clone_individual()

        # 二点交叉を行う
        for key in ch1.r_gen.controller.state_dict():
            cxpoint1 = random.randint(0, ch1.r_gen.controller.state_dict()[key].size()[0]-1)
            cxpoint2 = random.randint(0, ch1.r_gen.controller.state_dict()[key].size()[0]-1)

            if cxpoint1 > cxpoint2:
                cxpoint1, cxpoint2 = cxpoint2, cxpoint1
            
            temp = ch1.r_gen.controller.state_dict()[key][cxpoint1:cxpoint2].clone()
            ch1.r_gen.controller.state_dict()[key][cxpoint1:cxpoint2] = parent2.r_gen.controller.state_dict()[key][cxpoint1:cxpoint2]
            ch2.r_gen.controller.state_dict()[key][cxpoint1:cxpoint2] = temp
